...
description: >-
  How to create orders manually or in bulk on the Shiprocket panel, resolve
  panel issues, and understand order features
---
## Product Info
...
> Custom priority can only be set from the web panel at [https://app.shiprocket.in/courierPriority](https://app.shiprocket.in/courierPriority).
