...
### Early COD Plan Details

| Plan | Charge (incl. GST) | Remittance Day |
|---|---|---|
| Early COD D+2 | 0.99% | 3rd day from date of delivery |
| Early COD D+3 | 0.69% | 4th day from date of delivery |
| Early COD D+4 | 0.49% | 5th day from date of delivery |

### Important Notes

- **30-day mandatory period** — once activated, the plan cannot be deactivated before 30 days.
- Charges are deducted from COD remittance automatically.
- Seller should understand the percentage charges before activation.
- Remittance is processed on working days only (excluding Sundays and holidays).

### Path to Activate / Deactivate

**Activate:** Settings > Billing > Early COD > Select Plan > Activate

**Deactivate:** Settings > Billing > Shipping Charges > Early COD > Deactivate (only after 30 days)

### Script

> "Sir/Ma'am, Early COD plans allow you to receive your COD remittance faster. The plans available are D+2 at 0.99%, D+3 at 0.69%, and D+4 at 0.49% — all inclusive of GST. Please note that once activated, the plan has a mandatory 30-day period before it can be deactivated."
...
| FCR | Yes |
| SR Issue Category | COD Remittance |
| Sub Category | Early COD Related |
