...
description: >-
  GST queries, TDS claims, ledger requests, weight discrepancy, insurance
  claims, festive surcharge, and convenience fee
---
## Product Info
...
- RTO: Courier insures 40% of shipment value or Rs. 2,500 (whichever is lower).

- RVP: Courier insures 50% of shipment value or Rs. 2,500 (whichever is lower).
