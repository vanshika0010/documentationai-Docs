...
1. Ask seller for **Form 16A** (TDS certificate).
2. Assign the case to **"FOPS"** Channel.
3. Status: **Awaiting Customer Response**.
4. Create NFCR ticket under ACR Status.
5. Ask seller to share the required details within **24–48 hours**.
...
- Seller cannot claim TDS without GST registration.
- Inform seller to update GST first.
- Mark the case as **FCR Resolved** under "Customer Support Call Center" channel.
